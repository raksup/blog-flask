...
from wtforms.validators import DataRequired, equal_to, Length, Email, ValidationError
...
class RequestResetForm(FlaskForm):
    ...
    def validate_email(self, email):            #checks whether the entered email has an account in the database
        user = User.query.filter_by(email=email.data).first()
        if user is None:
